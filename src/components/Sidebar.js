...
const Sidebar = forwardRef(function Sidebar(
  ...
  return (
    <aside
      ref={ref}
      className={`bg-neutral-950 flex flex-col items-start justify-start border-r border-r-neutral-900 h-[calc(100vh-4rem)] top-16 p-6 gap-2 overflow-y-auto fixed z-50 w-64 left-0 ${
    ...
    >
      ...
      <div
        className={"flex flex-col items-start justify-start h-fit w-fit gap-0"}
      >
        <Link
        ...
        <Link
          href={"/components/buttons/danger"}
          className={`${ubuntu.className} font-normal text-start flex flex-wrap text-white justify-start items-start hover:underline underline-offset-4 px-3 py-2`}
        >
          Danger Button
        </Link>
