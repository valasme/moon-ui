...
export default function MoonDocsIntroduction() {
    ...
    return (<div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
            <Head>
                ...
                <link rel="canonical" href="https://moon-ui-app.vercel.app/docs/introduction"/>
                <link rel="manifest" href="/manifest.json"/>
                <link rel="icon" href="/favicon.png"/>
                <meta property="og:type" content="website"/>
                <meta property="og:url" content="https://moon-ui-app.vercel.app/docs/introduction"/>
                ...
                <meta name="twitter:url" content="https://moon-ui-app.vercel.app/docs/introduction"/>
            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                <Sidebar ref={sidebarRef} isShown={showSidebar} isSmallScreen={isSmallScreen}
                ...
                <aside
                    ...
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        <h1 className={`${ubuntu.className} font-bold text-left text-3xl sm:text-4xl text-white mb-2`}>Introduction</h1>
                        <p className={`${ubuntu.className} font-thin text-start flex flex-wrap items-start justify-start text-sm text-neutral-300 mb-8`}>
                            Here is everything in short about everything you need to know about this project.
                        </p>
                        <div className="w-64 h-px bg-neutral-900 mb-8"></div>
                        <p className={`${ubuntu.className} font-normal text-start flex flex-wrap items-start justify-start text-md text-neutral-300 w-full mb-12`}>
                            MoonUI is currently being 100% developed by Dimitris Valasellis, a proud front-end developer
                            who is fully dedicated to updating & using this project to all of his projects, even when it
                            doesn&apos;t match the theme.
                        </p>
                        <div className="w-32 h-px bg-neutral-900 mb-8"></div>
                        <p className={`${ubuntu.className} font-normal text-start flex flex-wrap items-start justify-start text-md text-neutral-300 w-full mb-12`}>
                            MoonUI is really simple, just find the component you need in the sidebar, scroll a bit, copy
                            the code and you now can paste the fully working component into your project, unless it has
                        ...
                        <div className="space-y-3 w-full mt-6 rounded-none">
                            <div className="border-b border-neutral-800 pb-3 px-3 py-2 rounded-none">
                                ...
                                >
                                    ...
                                    <span
                                        className={`transform transition-transform duration-100 ease-in-out ${open === 1 ? "rotate-180" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
                      <path fillRule="evenodd"
                            ...
                            clipRule="evenodd"/>
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-100 ease-in-out ${open === 1 ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                                    <p className={`${ubuntu.className} mt-2 text-sm text-neutral-400 pl-6 p-6`}>
                                        Yes, MoonUI will keep getting updated regularly without any errors & bugs.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="border-b border-neutral-800 pb-3 px-3 py-2 rounded-none">
                                ...
                                >
                                    How do I use MoonUI?
                                    <span
                                        className={`transform transition-transform duration-100 ease-in-out ${open === 2 ? "rotate-180" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
                      <path fillRule="evenodd"
                            d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z"
                            clipRule="evenodd"/>
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-100 ease-in-out ${open === 2 ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                                    <p className={`${ubuntu.className} mt-2 text-sm text-neutral-400 pl-6 p-6`}>
                                        Simply visit the Installation page, it&apos;s at the sidebar, there you will
                                        find everything you need to know on how to use the components of MoonUI.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="border-b border-neutral-800 pb-3 px-3 py-2 rounded-none">
                                ...
                                >
                                    What&apos;s the quality?
                                    <span
                                        className={`transform transition-transform duration-100 ease-in-out ${open === 3 ? "rotate-180" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
                      <path fillRule="evenodd"
                            d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z"
                            clipRule="evenodd"/>
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-100 ease-in-out ${open === 3 ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
                                    <p className={`${ubuntu.className} mt-2 text-sm text-neutral-400 pl-6 p-6`}>
                                        MoonUI components are promised with 100% quality code and hard-coded code, with
                                        simple code and quality components, everything will work perfectly.
                                    </p>
                                </div>
                            </div>
                        </div>
