...
export default function MoonDocsHowToUse() {
    ...
    return (<div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
            <Head>
                <title>MoonUI - How To Use</title>
                <meta name="title" content="MoonUI - How To Use"/>
                <meta name="description"
                      content="MoonUI how to use, here you will find how to use & install every component."/>
                <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
                <meta charSet="UTF-8"/>
                <meta name="robots" content="index, follow"/>
                <meta name="author" content="Valasellis Dimitris"/>
                <link rel="canonical" href="https://moon-ui-app.vercel.app/docs/howtouse"/>
                <link rel="manifest" href="/manifest.json"/>
                <link rel="icon" href="/favicon.png"/>
                <meta property="og:type" content="website"/>
                <meta property="og:url" content="https://moon-ui-app.vercel.app/docs/howtouse"/>
                <meta property="og:title" content="Moon UI - How To Use"/>
                ...
                <meta name="twitter:url" content="https://moon-ui-app.vercel.app/docs/howtouse"/>
                <meta name="twitter:title" content="Moon UI - How To Use"/>
            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                ...
                <aside
                    ...
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        <h1 className={`${ubuntu.className} font-bold text-left text-3xl sm:text-4xl text-white mb-2`}>How
                            To Use</h1>
                        <p className={`${ubuntu.className} font-thin text-start flex flex-wrap items-start justify-start text-sm text-neutral-300 mb-8`}>
                            Here is everything in short about everything you need to know about using the components.
                        </p>
                        ...
                        <p className={`${ubuntu.className} font-normal text-start flex flex-wrap items-start justify-start text-md text-neutral-300 w-full mb-12`}>
                            This is a primary button, this works for all of the components, simply copy the code or copy
                            the selected one that you want. They are pure HTML & Tailwind components, so yeah.
                        </p>

                        <section
                            className="flex flex-col border border-neutral-900 w-full p-12 rounded-xl bg-neutral-900/15 mb-12">
                            <h1 className={`${ubuntu.className} font-bold text-left text-2xl text-white mb-12`}>Example
                                Of A Component.</h1>

                            <div
                                className="flex justify-between items-center bg-neutral-900 border border-neutral-800 rounded-t-lg px-4 py-2 w-full">
                                <span className={`${ubuntu.className} text-neutral-400 text-sm`}>HTML Snippet</span>
                                <button
                                    id="copyButton"
                                    onClick={() => {
                                        const code = `export default function Example() {
    return (
