        ...
        <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
            ...
            >
                <div className="flex flex-col items-start w-full max-w-4xl">
                    ...
                    >
                        Here is everything in short about everything you need to know about
                    ...
                    >
                        This is a primary button, this works for all of the components,
                        simply copy the code or copy the selected one that you want. They
                        are pure HTML & Tailwind components, so yeah.
                    </p>

                    <section
                        className="flex flex-col border border-neutral-900 w-full p-12 rounded-xl bg-neutral-900/15 mb-12">
                        <h1
                            className={`${ubuntu.className} font-bold text-left text-2xl text-white mb-12`}
                        >
