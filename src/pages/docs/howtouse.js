  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/docs/howtouse"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/docs/howtouse"
        />
        ...
        <meta
          name="keywords"
          content="MoonUI how to use, UI library guide, component installation, web development tutorial, Tailwind CSS components, HTML components usage"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            <section className="flex flex-col border border-neutral-900 w-full p-12 rounded-xl bg-neutral-900/15 mb-12">
              <h1
              ...
              <div className="flex justify-between items-center bg-neutral-900 border border-neutral-800 rounded-t-lg px-4 py-2 w-full">
                <span
