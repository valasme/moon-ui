...
export default function MoonComponentsSkeletonButton() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Skeleton Button</title>
        <meta name="title" content="MoonUI - Skeleton Button" />
        <meta
          name="description"
          content="MoonUI skeleton button, used when loading pages."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/buttons/skeleton"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/buttons/skeleton"
        />
        <meta property="og:title" content="Moon UI - Skeleton Button" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Skeleton Button" />
        <meta
          name="twitter:description"
          content="MoonUI primary button, used when loading pages."
        />
        <meta name="twitter:image" content="/og-image.png" />
        <meta name="theme-color" content="#0a0a0a" />
        <meta
          name="keywords"
          content="MoonUI skeleton button, UI button component, Tailwind CSS button, web development button, HTML button, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The skeleton button is used when loading pages, let&apos;s say for
              example, a button that is supposed to load after 3 seconds etc.
            </p>
              ...
              <div className="flex flex-col w-full max-w-3xl">
                ...
                <div className="flex justify-between items-center bg-neutral-900 border-x border-t border-neutral-800 px-4 py-2">
                  ...
                  <button
                    id="copyButton"
                    onClick={() => {
                      const code = `<div class="h-10 bg-neutral-700 rounded-lg w-32 animate-pulse"></div>`;
                ...
                <div className="bg-neutral-950 border-x border-b border-neutral-800 rounded-b-lg w-full h-full">
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<div class="h-10 bg-neutral-700 rounded-lg w-32 animate-pulse"></div>`}
                  </pre>
                </div>
              </div>
            </section>
