  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        ...
        <meta
          name="description"
          content="MoonUI outline button, used across all pages."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/buttons/outline"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/buttons/outline"
        />
        ...
        <meta
          name="keywords"
          content="MoonUI outline button, UI button component, Tailwind CSS button, web development button, HTML button, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The outline button is used across some pages, let&apos;s say for
              example, a add to cart button.
            </p>
            ...
            <section className="flex flex-col w-full mb-12 items-start">
              <div className="flex flex-col w-full max-w-3xl">
                <div className="flex items-center justify-center w-full py-16 bg-neutral-950 border border-neutral-800 rounded-t-lg">
                  <button className="flex flex-row items-center justify-center cursor-pointer bg-transparent border border-neutral-900 hover:bg-neutral-900 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap">
                    Outline
                  </button>
                </div>
