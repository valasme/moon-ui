...
export default function MoonComponentsSecondaryButton() {
    ...
    return (<div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
        <Head>
            ...
            <meta name="description" content="MoonUI secondary button, used across all pages."/>
            <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
            <meta charSet="UTF-8"/>
            <meta name="robots" content="index, follow"/>
            <meta name="author" content="Valasellis Dimitris"/>
            <link rel="canonical" href="https://moon-ui-app.vercel.app/components/buttons/secondary"/>
            <link rel="manifest" href="/manifest.json"/>
            <link rel="icon" href="/favicon.png"/>
            <meta property="og:type" content="website"/>
            <meta property="og:url" content="https://moon-ui-app.vercel.app/components/buttons/secondary"/>
            <meta property="og:title" content="Moon UI - Secondary Button"/>
            <meta property="og:description" content="MoonUI secondary button, used across all pages."/>
            ...
            <meta name="twitter:description" content="MoonUI secondary button, used across all pages."/>
        ...
        <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
            ...
            <aside
                ...
                <div className="flex flex-col items-start w-full max-w-4xl">
                    ...
                    <h1 className={`${ubuntu.className} font-bold text-left text-3xl sm:text-4xl text-white mb-2`}>Secondary
                        Button</h1>
                    ...
                    <p className={`${ubuntu.className} font-thin text-start flex flex-wrap items-start justify-start text-sm text-neutral-300 mb-12`}>
                        The secondary button is used across all pages, let&apos;s say for example, a learn more button etc.
                    </p>
                    ...
                    <section className="flex flex-col w-full mb-12 items-start">
                        <div className="flex flex-col w-full max-w-3xl">
                            <div
                                ...
                                <button
                                    className="flex flex-row items-center justify-center cursor-pointer bg-neutral-100 hover:bg-neutral-200 duration-100 ease-in-out text-black transition-all px-3 py-2 rounded-lg flex-wrap">
                                    Secondary
                                </button>
                            </div>
