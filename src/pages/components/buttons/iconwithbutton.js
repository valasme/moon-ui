...
export default function MoonComponentsPrimaryButton() {
    ...
    return (
        <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
            <Head>
                <title>MoonUI - Icon With Button</title>
                <meta name="title" content="MoonUI - Icon With Button" />
                <meta
                    name="description"
                    content="MoonUI icon with button, used across some pages."
                />
                ...
                <link
                    rel="canonical"
                    href="https://moon-ui-app.vercel.app/components/buttons/iconwithbutton"
                />
                ...
                <meta
                    property="og:url"
                    content="https://moon-ui-app.vercel.app/components/buttons/iconwithbutton"
                />
                <meta property="og:title" content="Moon UI - Icon With Button" />
                <meta
                    property="og:description"
                    content="MoonUI primary button, used across some pages."
                />
                <meta property="og:image" content="/og-image.png" />
                <meta property="og:site_name" content="MoonUI" />
                <meta property="og:locale" content="en_US" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Moon UI - Icon With Button" />
                <meta
                    name="twitter:description"
                    content="MoonUI icon with button, used across all pages."
                />
                <meta name="twitter:image" content="/og-image.png" />
                <meta name="theme-color" content="#0a0a0a" />
                <meta
                    name="keywords"
                    content="MoonUI icon with button, UI button component, Tailwind CSS button, web development button, HTML button, component library"
                />
            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                ...
                >
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        >
                            The icon with button is used across some pages, let&apos;s say for
                            example, a notification button etc.
                        </p>
                        ...
                        <section className="flex flex-col w-full mb-12 items-start">
                            <div className="flex flex-col w-full max-w-3xl">
                                <div className="flex items-center justify-center w-full py-16 bg-neutral-950 border border-neutral-800 rounded-t-lg">
                                    <button className="flex flex-row items-center justify-center cursor-pointer bg-neutral-950 hover:bg-neutral-900 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap gap-2">
                  ...
                  >
                    HTML Snippet
                                    ...
                                    <button
                                        id="copyButton"
                                        onClick={() => {
                                            const code = `<button class="flex flex-row items-center justify-center cursor-pointer bg-neutral-950 hover:bg-neutral-900 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap gap-2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
        <path d="M3.6 1.7A.75.75 0 1 0 2.4.799a6.978 6.978 0 0 0-1.123 2.247.75.75 0 1 0 1.44.418c.187-.644.489-1.24.883-1.764ZM13.6.799a.75.75 0 1 0-1.2.9 5.48 5.48 0 0 1 .883 1.765.75.75 0 1 0 1.44-.418A6.978 6.978 0 0 0 13.6.799Z" />
        <path fill-rule="evenodd" d="M8 1a4 4 0 0 1 4 4v2.379c0 .398.158.779.44 1.06l1.267 1.268a1 1 0 0 1 .293.707V11a1 1 0 0 1-1 1h-2a3 3 0 1 1-6 0H3a1 1 0 0 1-1-1v-.586a1 1 0 0 1 .293-.707L3.56 8.44A1.5 1.5 0 0 0 4 7.38V5a4 4 0 0 1 4-4Zm0 12.5A1.5 1.5 0 0 1 6.5 12h3A1.5 1.5 0 0 1 8 13.5Z" clipRule="evenodd" />
    </svg>
        Icon With Button
</button>`;
                  ...
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<button class="flex flex-row items-center justify-center cursor-pointer bg-neutral-950 hover:bg-neutral-900 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap gap-2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
        <path d="M3.6 1.7A.75.75 0 1 0 2.4.799a6.978 6.978 0 0 0-1.123 2.247.75.75 0 1 0 1.44.418c.187-.644.489-1.24.883-1.764ZM13.6.799a.75.75 0 1 0-1.2.9 5.48 5.48 0 0 1 .883 1.765.75.75 0 1 0 1.44-.418A6.978 6.978 0 0 0 13.6.799Z" />
        <path fill-rule="evenodd" d="M8 1a4 4 0 0 1 4 4v2.379c0 .398.158.779.44 1.06l1.267 1.268a1 1 0 0 1 .293.707V11a1 1 0 0 1-1 1h-2a3 3 0 1 1-6 0H3a1 1 0 0 1-1-1v-.586a1 1 0 0 1 .293-.707L3.56 8.44A1.5 1.5 0 0 0 4 7.38V5a4 4 0 0 1 4-4Zm0 12.5A1.5 1.5 0 0 1 6.5 12h3A1.5 1.5 0 0 1 8 13.5Z" clipRule="evenodd" />
    </svg>
