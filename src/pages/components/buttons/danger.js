...
export default function MoonComponentsDangerButton() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Danger Button</title>
        <meta name="title" content="MoonUI - Danger Button" />
        <meta
          name="description"
          content="MoonUI danger button, used across all pages."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/buttons/danger"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/buttons/danger"
        />
        <meta property="og:title" content="Moon UI - Danger Button" />
        <meta
          property="og:description"
          content="MoonUI danger button, used across some pages."
        />
        ...
        <meta
          name="keywords"
          content="MoonUI danger button, UI button component, Tailwind CSS button, web development button, HTML button, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The danger button is used across some pages, let&apos;s say for
              example, a delete user button etc.
            </p>
            ...
            <section className="flex flex-col w-full mb-12 items-start">
              <div className="flex flex-col w-full max-w-3xl">
                <div className="flex items-center justify-center w-full py-16 bg-neutral-950 border border-neutral-800 rounded-t-lg">
                  <button className="flex flex-row items-center justify-center cursor-pointer bg-red-500 hover:bg-red-500/90 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap">
                    Danger
                  </button>
                </div>
                ...
                <div className="flex justify-between items-center bg-neutral-900 border-x border-t border-neutral-800 px-4 py-2">
                  ...
                  <button
                    id="copyButton"
                    onClick={() => {
                      const code = `<button class="flex flex-row items-center justify-center cursor-pointer bg-red-500 hover:bg-red-500/90 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap">Primary</button>`;
                ...
                <div className="bg-neutral-950 border-x border-b border-neutral-800 rounded-b-lg w-full h-full">
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<button class="flex flex-row items-center justify-center cursor-pointer bg-red-500 hover:bg-red-500/90 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap">
    Danger
</button>`}
                  </pre>
                </div>
