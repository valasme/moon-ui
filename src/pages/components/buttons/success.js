            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                ...
                >
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        >
                            The success button is used across some pages, let&apos;s say for
                            example, a confirm purchase button etc.
                        </p>
                  ...
                  >
                    HTML Snippet
                                    ...
                                    <button
                                        id="copyButton"
                                        onClick={() => {
                                            const code = `<button class="flex flex-row items-center justify-center cursor-pointer bg-green-400 hover:bg-green-400/90 duration-100 ease-in-out text-white transition-all px-3 py-2 rounded-lg flex-wrap">Success</button>`;
