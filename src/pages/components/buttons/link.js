...
export default function MoonComponentsLinkButton() {
    ...
    return (<div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
            <Head>
                <title>MoonUI - Link Button</title>
                <meta name="title" content="MoonUI - Link Button"/>
                <meta
                    name="description"
                    content="MoonUI link button, used across most pages."
                />
                ...
                <link
                    rel="canonical"
                    href="https://moon-ui-app.vercel.app/components/buttons/link"
                />
                ...
                <meta
                    property="og:url"
                    content="https://moon-ui-app.vercel.app/components/buttons/link"
                />
                <meta property="og:title" content="Moon UI - Link Button"/>
                <meta
                ...
                <meta name="twitter:title" content="Moon UI - Link Button"/>
                <meta
                ...
                <meta
                    name="keywords"
                    content="MoonUI link button, UI button component, Tailwind CSS button, web development button, HTML button, component library"
                />
            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                ...
                >
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        >
                            The link button is used across most pages, let&apos;s say for
                            example, a author link etc.
                        </p>
                        ...
                        <section className="flex flex-col w-full mb-12 items-start">
                            <div className="flex flex-col w-full max-w-3xl">
                                <div
                                    ...
                                    <button
                                        className="flex flex-row items-center justify-center cursor-pointer hover:underline underline-offset-4 hover:text-blue-500 duration-100 ease-in-out text-white transition-all px-3 py-2 flex-wrap">
                                        Link
                                    </button>
                                </div>
                  ...
                  >
                    HTML Snippet
                                    ...
                                    <button
                                        id="copyButton"
                                        onClick={() => {
                                            const code = `<button class="flex flex-row items-center justify-center cursor-pointer hover:underline underline-offset-4 hover:text-blue-500 duration-100 ease-in-out text-white transition-all px-3 py-2 flex-wrap">Link</button>`;
                  ...
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<button class="flex flex-row items-center justify-center cursor-pointer hover:underline underline-offset-4 hover:text-blue-500 duration-100 ease-in-out text-white transition-all px-3 py-2 flex-wrap">
    Link
</button>`}
                  </pre>
                                </div>
