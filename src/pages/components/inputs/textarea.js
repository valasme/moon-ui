...
export default function MoonComponentsTextareaInput() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Textarea Input</title>
        <meta name="title" content="MoonUI - Textarea Input" />
        <meta
          name="description"
          content="MoonUI textarea, used across forms for multi-line text input."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/inputs/textarea"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/inputs/textarea"
        />
        <meta property="og:title" content="Moon UI - Textarea Input" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Textarea Input" />
        <meta
        ...
        <meta
          name="keywords"
          content="MoonUI textarea, UI input component, Tailwind CSS textarea, web development input, HTML textarea, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The textarea input is used across some pages, let&apos;s say for
              example, comments, descriptions or other multi-line fields etc.
            </p>
