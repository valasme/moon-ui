...
export default function MoonComponentsTelephoneInput() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Telephone Input</title>
        <meta name="title" content="MoonUI - Telephone Input" />
        <meta
          name="description"
          content="MoonUI telephone input, used across contact forms and phone fields."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/inputs/telephone"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/inputs/telephone"
        />
        <meta property="og:title" content="Moon UI - Telephone Input" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Telephone Input" />
        <meta
        ...
        <meta
          name="keywords"
          content="MoonUI telephone input, UI input component, Tailwind CSS input, web development input, HTML input, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The telephone input is used across some pages, let&apos;s say for
              example, contact forms or phone number fields etc.
            </p>
