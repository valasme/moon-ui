...
export default function MoonComponentsPasswordInput() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Date Input</title>
        <meta name="title" content="MoonUI - Date Input" />
        <meta
          name="description"
          content="MoonUI date input, used across some pages, let's say for example, a date input or in a calendar application etc."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/inputs/date"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/inputs/date"
        />
        <meta property="og:title" content="Moon UI - Date Input" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Date Input" />
        <meta
        ...
        <meta
          name="keywords"
          content="MoonUI date input, UI input component, Tailwind CSS input, web development input, HTML input, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The date input is used across some pages, let&apos;s say for
              example, a date input or in a calendar application etc.
            </p>
