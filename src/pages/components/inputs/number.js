...
export default function MoonComponentsNumberInput() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Number Input</title>
        <meta name="title" content="MoonUI - Number Input" />
        <meta
          name="description"
          content="MoonUI number input, used across forms where numeric values are needed."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/inputs/number"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/inputs/number"
        />
        <meta property="og:title" content="Moon UI - Number Input" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Number Input" />
        <meta
        ...
        <meta
          name="keywords"
          content="MoonUI number input, UI input component, Tailwind CSS input, web development input, HTML input, component library"
        />
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              The number input is used across some pages, let&apos;s say for
              example, quantity, price or other numeric fields etc.
            </p>
              ...
              <div className="flex flex-col w-full max-w-3xl">
                ...
                <div className="flex justify-between items-center bg-neutral-900 border-x border-t border-neutral-800 px-4 py-2">
                  ...
                  <button
                    id="copyButton"
                    onClick={() => {
                      const code = `<input type="number" placeholder="Enter Number..." class="flex w-fit h-fit px-4 py-2 border-none focus:ring-0 ring-0 outline-0 focus:outline-0 flex-row justify-start items-start text-start flex-wrap bg-neutral-900 hover:bg-neutral-900/80 overflow-auto duration-100 ease-in-out font-sans rounded-md" />`;
                ...
                <div className="bg-neutral-950 border-x border-b border-neutral-800 rounded-b-lg w-full h-full">
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<input type="number" placeholder="Enter Number..." class="flex w-fit h-fit px-4 py-2 border-none focus:ring-0 ring-0 outline-0 focus:outline-0 flex-row justify-start items-start text-start flex-wrap bg-neutral-900 hover:bg-neutral-900/80 overflow-auto duration-100 ease-in-out font-sans rounded-md" />`}
                  </pre>
                </div>
              </div>
            </section>
