...
export default function MoonComponentsPasswordInput() {
    ...
    return (
        <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
            <Head>
                <title>MoonUI - Password Input</title>
                <meta name="title" content="MoonUI - Password Input"/>
                <meta
                    name="description"
                    content="MoonUI password input, used across login & sign-up pages."
                />
                ...
                <link
                    rel="canonical"
                    href="https://moon-ui-app.vercel.app/components/inputs/password"
                />
                ...
                <meta
                    property="og:url"
                    content="https://moon-ui-app.vercel.app/components/inputs/password"
                />
                <meta property="og:title" content="Moon UI - Password Input"/>
                <meta
                ...
                <meta name="twitter:title" content="Moon UI - Password Input"/>
                <meta
                ...
                <meta
                    name="keywords"
                    content="MoonUI password input, UI input component, Tailwind CSS input, web development input, HTML input, component library"
                />
            ...
            <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
                ...
                >
                    <div className="flex flex-col items-start w-full max-w-4xl">
                        ...
                        >
                            The password input is used across all pages, let&apos;s say for
                            example, a password input or in login & sign-up pages etc.
                        </p>
                        ...
                        <section className="flex flex-col w-full mb-12 items-start">
                            <div className="flex flex-col w-full max-w-3xl">
                                <div
                                    ...
                                    <input type={"password"} placeholder={"Enter Password..."} className={"flex w-fit h-fit px-4 py-2 border-none focus:ring-0 ring-0 outline-0 focus:outline-0 flex-row justify-start items-start text-start flex-wrap bg-neutral-900 hover:bg-neutral-900/80 overflow-auto duration-100 ease-in-out font-sans rounded-md"}/>
                                </div>
                  ...
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<input type="password" placeholder="Enter Password..." class="flex w-fit h-fit px-4 py-2 border-none focus:ring-0 ring-0 outline-0 focus:outline-0 flex-row justify-start items-start text-start flex-wrap bg-neutral-900 hover:bg-neutral-900/80 overflow-auto duration-100 ease-in-out font-sans rounded-md" />`}
                  </pre>
                                </div>
                            </div>
                        </section>
