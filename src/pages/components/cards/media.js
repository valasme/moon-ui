...
export default function MoonComponentsMediaCard() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - Media Card</title>
        <meta name="title" content="MoonUI - Media Card" />
        <meta
          name="description"
          content="Media card for displaying featured images or videos with title and description."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/cards/media"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/cards/media"
        />
        <meta property="og:title" content="Moon UI - Media Card" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - Media Card" />
        <meta
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              A media card is ideal for news feeds or blog lists, highlighting a
              featured image or video with a clear title and supporting
              description.
            </p>
            ...
            <section className="flex flex-col w-full mb-12 items-start">
              <div className="flex flex-col w-full max-w-3xl">
                <div className="flex items-center justify-center w-full py-16 bg-neutral-950 border border-neutral-800 rounded-t-lg">
                  <article className="flex flex-col w-full max-w-md bg-neutral-950 border border-neutral-800 rounded-xl overflow-hidden shadow-sm hover:border-neutral-700 hover:bg-neutral-950/80 transition-colors duration-150">
                    <div className="relative h-40 w-full bg-neutral-900/80">
                      ...
                      <div className="absolute bottom-3 left-3 inline-flex items-center rounded-full border border-neutral-700 bg-neutral-900/80 px-2.5 py-1 text-[11px] uppercase tracking-[0.18em] text-neutral-300">
                        Featured
                      </div>
                    </div>
                    <div className="flex flex-col gap-2 px-4 py-4">
                      ...
                      <h2 className="text-sm sm:text-base font-semibold text-white leading-snug">
                        Building elegant monochrome UI layouts for modern web
                        apps
                      </h2>
                      <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed">
                        Learn how to combine typography, spacing, and a
                        restrained color palette to create calm, focused
                        interfaces.
                      </p>
                      <div className="mt-3 flex flex-col gap-1 text-[11px] text-neutral-500 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex justify-between items-center bg-neutral-900 border-x border-t border-neutral-800 px-4 py-2">
                  ...
                  <button
                    id="copyButton"
                    onClick={() => {
                      const code = `<article class="flex flex-col w-full max-w-md bg-neutral-950 border border-neutral-800 rounded-xl overflow-hidden shadow-sm hover:border-neutral-700 hover:bg-neutral-950/80 transition-colors duration-150">
  <div class="relative h-40 w-full bg-neutral-900/80">
    <div class="absolute inset-0 bg-linear-to-t from-neutral-950/70 to-transparent"></div>
    <div class="absolute bottom-3 left-3 inline-flex items-center rounded-full border border-neutral-700 bg-neutral-900/80 px-2.5 py-1 text-[11px] uppercase tracking-[0.18em] text-neutral-300">
      Featured
    </div>
  </div>
  <div class="flex flex-col gap-2 px-4 py-4">
    <span class="text-xs font-medium uppercase tracking-[0.2em] text-neutral-500">Design</span>
    <h2 class="text-sm sm:text-base font-semibold text-white leading-snug">
      Building elegant monochrome UI layouts for modern web apps
    </h2>
    <p class="text-xs sm:text-sm text-neutral-400 leading-relaxed">
      Learn how to combine typography, spacing, and a restrained color palette to create calm, focused interfaces.
    </p>
        ...
        6 min read
                ...
                <div className="bg-neutral-950 border-x border-b border-neutral-800 rounded-b-lg w-full h-full">
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<article class="flex flex-col w-full max-w-md bg-neutral-950 border border-neutral-800 rounded-xl overflow-hidden shadow-sm hover:border-neutral-700 hover:bg-neutral-950/80 transition-colors duration-150">
  <div class="relative h-40 w-full bg-neutral-900/80">
    <div class="absolute inset-0 bg-linear-to-t from-neutral-950/70 to-transparent"></div>
    <div class="absolute bottom-3 left-3 inline-flex items-center rounded-full border border-neutral-700 bg-neutral-900/80 px-2.5 py-1 text-[11px] uppercase tracking-[0.18em] text-neutral-300">
      Featured
