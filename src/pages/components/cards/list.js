...
export default function MoonComponentsListCard() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-950 scroll-auto overflow-auto m-0 p-0">
      <Head>
        <title>MoonUI - List Card</title>
        <meta name="title" content="MoonUI - List Card" />
        <meta
          name="description"
          content="List card for compact rows inside larger cards or multi-level layouts."
        />
        ...
        <link
          rel="canonical"
          href="https://moon-ui-app.vercel.app/components/cards/list"
        />
        ...
        <meta
          property="og:url"
          content="https://moon-ui-app.vercel.app/components/cards/list"
        />
        <meta property="og:title" content="Moon UI - List Card" />
        <meta
        ...
        <meta name="twitter:title" content="Moon UI - List Card" />
        <meta
      ...
      <main className="flex flex-row m-0 p-0 min-h-screen relative pr-0 pl-0">
        ...
        >
          <div className="flex flex-col items-start w-full max-w-4xl">
            ...
            >
              A list card is a compact row used inside larger cards or lists to
              display key information and status.
            </p>
            ...
            <section className="flex flex-col w-full mb-12 items-start">
              <div className="flex flex-col w-full max-w-3xl">
                <div className="flex items-center justify-center w-full py-16 bg-neutral-950 border border-neutral-800 rounded-t-lg">
                  <div className="w-full max-w-md divide-y divide-neutral-900 rounded-xl border border-neutral-800 bg-neutral-950 shadow-sm">
                    <article className="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[11px] text-neutral-500">
                          Components · Due today
                        </span>
                      </div>
                      <span className="inline-flex items-center rounded-full bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-300">
                        In progress
                      </span>
                    </article>
                    <article className="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[11px] text-neutral-500">
                          UI · Low contrast check
                        </span>
                      </div>
                      <span className="inline-flex items-center rounded-full bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-400">
                        Review
                      </span>
                    </article>
                    <article className="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex justify-between items-center bg-neutral-900 border-x border-t border-neutral-800 px-4 py-2">
                  ...
                  <button
                    id="copyButton"
                    onClick={() => {
                      const code = `<div class="w-full max-w-md divide-y divide-neutral-900 rounded-xl border border-neutral-800 bg-neutral-950 shadow-sm">
  <article class="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
    <div class="flex flex-col">
      <span class="text-sm font-medium text-white">Update cards documentation</span>
      <span class="text-[11px] text-neutral-500">Components · Due today</span>
    </div>
    <span class="inline-flex items-center rounded-full bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-300">In progress</span>
  </article>
  <article class="flex items-center justify-between gap-3 px-4 py-3">
    <div class="flex flex-col">
      <span class="text-sm font-medium text-white">Polish media card</span>
      <span class="text-[11px] text-neutral-500">UI · Low contrast check</span>
    </div>
    <span class="inline-flex items-center rounded-full bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-400">Review</span>
  </article>
  <article class="flex items-center justify-between gap-3 px-4 py-3">
    <div class="flex flex-col">
      <span class="text-sm font-medium text-white">Ship v1.2.0</span>
      <span class="text-[11px] text-neutral-500">Release · Next week</span>
    </div>
    <span class="inline-flex items-center rounded-full bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-400">Planned</span>
  </article>
</div>`;
                ...
                <div className="bg-neutral-950 border-x border-b border-neutral-800 rounded-b-lg w-full h-full">
                  <pre className="text-neutral-300 text-sm overflow-x-auto p-6 w-full h-full">
                    {`<div class="w-full max-w-md divide-y divide-neutral-900 rounded-xl border border-neutral-800 bg-neutral-950 shadow-sm">
  <article class="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
    <div class="flex flex-col">
      <span class="text-sm font-medium text-white">Update cards documentation</span>
      <span class="text-[11px] text-neutral-500">Components · Due today</span>
